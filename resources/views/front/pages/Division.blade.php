    ...
    <div style="margin-top: 200px">
        ...
        <section class="section-boxed section-classic">
            <div class="image-container">
                <img src="{{ $division['photo'] }}" alt="Cardiovascular Homer" class="image-responsive" />
            </div>

            <div class="content-section">
                <h4 class="">{{ __('home.overview') }} ~</h4>
                <p>{{ $division['overview'] }}</p>
            </div>

            <div class="content-section">
                <h4 class="">{{ __('home.approach') }} ~</h4>
                <p>{{ $division['approach'] }}</p>
            </div>
